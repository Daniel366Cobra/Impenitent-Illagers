...
import com.daniel366cobra.pitilesspillagers.entity.MusketAttackGoal;
...
public class InterloperPillagerEntity extends IllagerEntity implements MusketUser, InventoryOwner {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new MusketAttackGoal<>(this, 1.0, 20.0f));
        this.goalSelector.add(8, new WanderAroundGoal(this, 0.6));
        this.goalSelector.add(9, new LookAtEntityGoal(this, PlayerEntity.class, 20.0f, 1.0f));
        this.goalSelector.add(10, new LookAtEntityGoal(this, MobEntity.class, 20.0f));
    ...
    protected void initEquipment(LocalDifficulty difficulty) {
        this.equipStack(EquipmentSlot.MAINHAND, new ItemStack(ModItems.MUSKET));
    }
    ...
    public IllagerEntity.State getState() {
        ...
        if (this.isHolding(ModItems.MUSKET) && this.isAiming()) {
