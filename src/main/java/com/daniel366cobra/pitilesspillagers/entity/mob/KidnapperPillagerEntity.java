...
public class KidnapperPillagerEntity extends IllagerEntity {

    protected BlockPos retreatBlockPos = BlockPos.ORIGIN;

    public KidnapperPillagerEntity(EntityType<? extends IllagerEntity> entityType, World world) {
    ...
    public static class KidnapVillagerGoal extends Goal {
        ...
        private final KidnapperPillagerEntity executorMob;
        ...
        KidnapVillagerGoal(KidnapperPillagerEntity mob, double speed, int range, int maxYDifference){
