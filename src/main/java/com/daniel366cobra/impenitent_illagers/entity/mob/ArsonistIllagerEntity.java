...
public class ArsonistIllagerEntity extends IllagerEntity
{

    public ArsonistIllagerEntity(EntityType<? extends IllagerEntity> entityType, World world) {
    ...
    class IgniteBlockGoal extends Goal {
        ...
        public void tickIgniting(WorldAccess world, BlockPos pos) {
            world.playSound(null, pos, SoundEvents.ITEM_FLINTANDSTEEL_USE, SoundCategory.HOSTILE, 0.5f, 0.9f + ArsonistIllagerEntity.this.random.nextFloat() * 0.2f);
        }

        public void onIgniteBlock(WorldAccess world, BlockPos pos) {
            world.playSound(null, pos, SoundEvents.ITEM_FIRECHARGE_USE, SoundCategory.BLOCKS, 0.7f, 0.9f + ArsonistIllagerEntity.this.random.nextFloat() * 0.2f);
        }
